"""
Django settings for micro-ecommerce project.
...
ROOT_URLCONF = 'micro-ecommerce.urls'
...
TEMPLATES = [
    {
        ...
        'OPTIONS': {
            'context_processors': [
                ...
                'micro-ecommerce.context_processors.vendor_files',
...
WSGI_APPLICATION = 'micro-ecommerce.wsgi.application'
